...
export function UploadModal({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert('Failed to upload snippet. See console for details.');
        } finally {
    ...
    const handleFileRead = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // Auto-detect language by extension roughly
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2 flex-1 min-h-[300px]">
                        ...
                        <textarea
                            ...
                            className="w-full flex-1 bg-gray-900 text-gray-100 font-mono text-sm leading-tight p-4 rounded-xl border-0 focus:ring-2 focus:ring-indigo-500 outline-none resize-none shadow-inner"
                    ...
                    <div className="pt-2 flex justify-end gap-3 border-t border-gray-100 mt-2">
                        ...
                        >
                            {isSubmitting ? 'Uploading...' : 'Publish Snippet'}
                        </button>
                    </div>
                </form>
            </div>
